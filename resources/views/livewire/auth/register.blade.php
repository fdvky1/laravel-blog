        ...
        <div class="flex justify-center">
            <div class="">
                <div class="bg-white rounded-lg shadow-md p-8">
                    <div class="">
                        <h5 class="text-center mb-4 text-2xl font-bold">CREATE ACCOUNT</h5>
                        @if ($message = Session::get('error'))
                        <h3 class="mb-4 font-bold text-red-500 w-full border-red-300 border bg-red-100 py-2 px-3 rounded-md">{{$message}}</h3>
                        @endif
                        <form wire:submit.prevent="store">
                            <div class="mb-3">
                                <label class="font-semibold text-base text-gray-700" for="name">Username</label>
                                <br/>
                                <input id="name" type="text" required wire:model.lazy="name"
                            ...
                            <div class="mb-3">
                                <label class="font-semibold text-base text-gray-700" for="confirm-password">Confirm Password</label>
                                <br/>
                                <input id="confirm-password" type="password" required wire:model.lazy="password_confirmation"
                                    class="rounded border w-full py-1 px-3"
                                    placeholder="type your password">
                            </div>
